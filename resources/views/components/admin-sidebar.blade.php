...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 mt-1 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gradient-to-b from-[#ffe5ec] to-[#b8c6db] border-r border-[#f8edeb] pl-3 pr-3 py-3" aria-label="Sidebar">
   <div class="h-full py-4 overflow-y-auto px-1">
      <ul class="space-y-2 font-medium mt-5">
         <!-- Dashboard -->
         <li>
            <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 pl-2 text-[#3d405b] rounded-lg hover:bg-[#055970] group">
               <!-- Home Icon -->
               ...
               <span class="ms-2 group-hover:text-[#ffffff]">Dashboard</span>
            </a>
         </li>

         <!-- Users Dropdown -->
         <li>
            <button type="button" class="flex items-center w-full p-2 pl-2 text-[#ffffff] rounded-lg transition duration-75 group hover:bg-[#055970]" aria-controls="dropdown-users" data-collapse-toggle="dropdown-users">
               <!-- Users Icon -->
               <svg class="w-5 h-5 text-[#055970] group-hover:text-[#118ab2]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
               ...
               <svg class="w-3 h-3 ms-auto text-[#055970]" fill="currentColor" viewBox="0 0 10 6">
                  <path d="M0 0l5 6 5-6H0z"/>
               </svg>
            </button>
            <ul id="dropdown-users" class="hidden py-2 space-y-2">
               <li>
                  <a href="{{ route('user.index') }}" class="flex items-center w-full p-2 pl-8 text-[#3d405b] rounded-lg group hover:bg-[#055970]">
                     <!-- User Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                     ...
                     <span class=group-hover:text-[#ffffff]>Customers</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('admin.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Shield Check Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4"/>
                     </svg>
                     <span class=group-hover:text-[#ffffff]>Administrator</span>
                  </a>
               </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <ul id="dropdown-inventory" class="hidden py-2 space-y-2 mt-2">
               <li>
                  <a href="{{ route('products.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Clipboard List Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                     ...
                     <span class=group-hover:text-[#ffffff]>All Products</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('admin.product.create') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Plus Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
                     </svg>
                     <span class=group-hover:text-[#ffffff]>Add New Product</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('category.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Tag Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                     ...
                     <span class=group-hover:text-[#ffffff]>Categories</span>
                  </a>
               </li>
               <li>
                  <a href="#" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Chart Bar Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                     ...
                     <span class=group-hover:text-[#ffffff]>Reports</span>
                  </a>
               </li>
               <li>
                  <a href="#" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     ...
                     <span class=group-hover:text-[#ffffff]>Product Archive</span>
                  </a>
               </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <ul id="dropdown-transaction" class="hidden py-2 space-y-2 mt-2">
               <li>
                  <a href="{{ route('all-transaction.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- List Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"/>
                     </svg>
                     <span class=group-hover:text-[#ffffff]>All Transactions</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('failed-transaction.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- X Circle Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 9l-6 6m0-6l6 6"/>
                     </svg>
                     <span class=group-hover:text-[#ffffff]>Failed Transactions</span>
                  </a>
               </li>
               <li>
                  <a href="{{ route('successful-transaction.index') }}" class="flex items-center w-full p-2 pl-8 text-[#055970] rounded-lg group hover:bg-[#055970]">
                     <!-- Check Circle Icon -->
                     <svg class="w-5 h-5 mr-2 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2l4-4"/>
                     </svg>
                     <span class=group-hover:text-[#ffffff]>Successful Transactions</span>
                  </a>
               </li>
            </ul>
         </li>
         ...
         <li>
            <a href="{{ route('admin.statistics') }}" class="flex items-center p-2 pl-2 text-[#055970] rounded-lg hover:bg-[#055970] group">
               ...
               <span class="ms-2 group-hover:text-[#ffffff]">Statistics & Graphs</span>
            </a>
         </li>

         <!-- Event Log -->
         <li>
            <a href="{{ route('admin.event-logs') }}" class="flex items-center p-2 pl-2 text-[#055970] rounded-lg hover:bg-[#055970] group">
               <!-- Clipboard Icon -->
               <svg class="w-5 h-5 text-[#055970] group-hover:text-[#ffffff]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
         ...
         <li>
            <a href="#" class="flex items-center p-2 pl-2 text-[#055970] rounded-lg hover:bg-[#055970] group">
               ...
               <span class="ms-2 group-hover:text-[#ffffff]">Settings</span>
            </a>
         </li>
         ...
         <li>
            <a href="#" 
               ...
               class="flex items-center p-2 pl-2 text-[#055970] rounded-lg hover:bg-[#055970] group">
               ...
               <!-- Logout Text -->
               <span class="ms-2 text-[#3d405b] group-hover:text-[#ffffff]">Logout</span>
            </a>
