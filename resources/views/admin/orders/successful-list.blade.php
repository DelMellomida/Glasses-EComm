<x-admin-layout>
    ...
    <style>
        #successful_transactions_list tbody tr:nth-child(even) { background-color: #ededed !important; }
        #successful_transactions_list tbody tr:nth-child(odd) { background-color: #ffffff !important; }
        #successful_transactions_list tbody tr { color: #3d405b !important; border-bottom: 1px solid #ffd6e0 !important; }
        #successful_transactions_list tbody tr:hover { background-color: #b6d8e2 !important; transition: background 0.2s; }
