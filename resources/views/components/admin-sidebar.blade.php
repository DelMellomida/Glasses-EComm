...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 mt-3 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full py-4 overflow-y-auto bg-[#1f2937] px-1">
      <ul class="space-y-2 font-medium">
         ...
         <!-- Users Dropdown -->
         <li>
            <button type="button" class="flex items-center w-full p-2 pl-2 text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-users" data-collapse-toggle="dropdown-users">
               <!-- Users Icon -->
               <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
               ...
               <svg class="w-3 h-3 ms-auto" fill="currentColor" viewBox="0 0 10 6">
            ...
            <ul id="dropdown-users" class="hidden py-2 space-y-2 mt-2">
               ...
               <li>
                  <a href="{{ route('admin.index') }}" class="flex items-center w-full p-2 pl-8 text-gray-900 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                     <!-- Shield Check Icon -->
                     <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
         ...
         <!-- Inventory Dropdown -->
         <li>
            <button type="button" class="flex items-center w-full p-2 pl-2 text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-inventory" data-collapse-toggle="dropdown-inventory">
               <!-- Cube Icon -->
               <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <ul id="dropdown-inventory" class="hidden py-2 space-y-2 mt-2">
               ...
               <li>
                  <a href="{{ route('category.index') }}" class="flex items-center w-full p-2 pl-8 text-gray-900 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                     <!-- Tag Icon -->
                     <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 pl-2 text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-transaction" data-collapse-toggle="dropdown-transaction">
               <!-- Credit Card Icon -->
               <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
