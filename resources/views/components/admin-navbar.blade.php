<nav class="bg-[#1f2937] border-gray-200 dark:bg-[#1f2937] fixed top-0 left-0 w-full z-[9999] shadow">
  <div class="flex items-center justify-between p-4">
    
    <!-- Logo pushed to the left edge -->
    <a href={{ route('guest.guest-home') }} class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sarabia Optical</span>
    </a>

    <!-- Admin/User Icon on the right -->
