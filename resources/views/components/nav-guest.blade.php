  ...
  <div class="max-w-full flex items-center mx-auto px-4 py-2">
    ...
    <div class="flex items-center">
      <ul class="flex items-center space-x-2">
        ...
        <li>
          <x-nav-link href="{{ route('about-us') }}" :active="request()->is('about')" class="text-white hover:text-blue-200 px-4 md-min-px-1 py-1">About Us</x-nav-link>
        </li>
        <li>
          <x-nav-link href="{{ route('contacts') }}" :active="request()->is('contact')" class="text-white hover:text-blue-200 px-4 md-min-px-1 py-1">Contact</x-nav-link>
        </li>
      </ul>
    </div>
