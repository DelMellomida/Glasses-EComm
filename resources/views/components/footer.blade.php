        ...
        <div>
          ...
          <div class="flex justify-center md:justify-start gap-6 text-gray-700">
            ...
            <a href="#" aria-label="Facebook"
               class="hover:text-[#f04e37] transition duration-300 transform hover:scale-110 hover:shadow-lg active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#f04e37]">
