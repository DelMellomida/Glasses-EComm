<x-admin-layout>
    ...
    <style>
        ...
        #successful_transactions_list tbody tr:nth-child(even) {
            background-color: #155E75 !important;
        }
        #successful_transactions_list tbody tr:nth-child(odd) {
            background-color: #1E293B !important;
        }
        #successful_transactions_list tbody tr {
            color: #E0F2FE !important;
            border-bottom: 1px solid #38BDF8 !important;
        }
        #successful_transactions_list tbody tr:hover {
            background-color: #0E7490 !important;
            transition: background 0.2s;
        }
        #successful_transactions_list th, #successful_transactions_list td {
            border-radius: 6px;
            border: 1px solid rgba(56,189,248,0.15);
        }
        #successful_transactions_list {
            border-radius: 12px;
            overflow: hidden;
        }
        #successful_transactions_list tbody tr:nth-child(even) {
