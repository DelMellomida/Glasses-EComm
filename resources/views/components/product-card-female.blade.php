...
>
    <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        @forelse ($products->whereIn('gender', ['female', 'unisex']) as $product)
            @php
                $hasImage = false;
                $imagePath = null;
                    ...
                    <div>
                        @if (auth()->user())
                            <div class="flex gap-2">
                                <template x-if="'{{ strtolower($product->category->availability_type ?? '') }}' === 'online'">
                                    <button
                                        ...
                                        @click="buyingModal = true; buyingProduct = {{ json_encode($product) }}; quantity = 1;"
                                    >
                                        BUY
                                    </button>
                                </template>
