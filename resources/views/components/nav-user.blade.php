<nav class="fixed w-full h-20 z-20 top-0 start-0" style="background-color: #0f7b99;" x-data="{ open: false }">
  <div class="max-w-full flex items-center mx-auto p-4"> 
    ...
    <div class="flex items-center">
      ...
      <div class="relative">
        @if(auth()->user())
          <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-blue-200 focus:outline-none transition duration-150 ease-in-out">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white z-50">
          @auth
